'use strict';
    ...
    const cart = {
        ...
        renderEmptyCart() {
            ...
            // document.querySelector('#clearthispingCart').style.display = 'none';    //временное решение
        ...
        renderCartList() {
            this.cartBlock.innerHTML = '';
            // document.querySelector('#clearthispingCart').style.display = 'inherit';  //временное решение
            this.cartBlock.insertAdjacentHTML('beforeend', `
                    <tr>
